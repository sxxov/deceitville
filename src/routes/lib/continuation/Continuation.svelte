		...
		<div class="content">
			...
			<section>
				...
				<p>
					...
					tricking users into doing things they didn't want to do, but
					that the designer wanted them to do.
				</p>
			</section>
			<section>
				...
				<p>
					...
					just by simply browsing the web. They are everywhere. When
					you accept some terms & conditions, when you try to opt out
					of receiving marketing emails, when you try not to give
					Facebook all your information & soul, etc.
				</p>
			</section>
			<section>
				...
				<p>
					...
					>
					website, detailing types & instances of deceptive design found
					in the wild. It has since been picked up by largely by the acedemic
					community, with
					<a
						href="https://scholar.google.com/scholar?hl=en&q=dark+pattern+brignull"
						target="_blank">countless articles being published</a
					>
